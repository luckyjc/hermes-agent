    ...
    "parameters": {
        ...
        "properties": {
            ...
            "lane": {
                "type": "string",
                "description": (
                    "Optional configured delegation lane applied to every task "
                    "unless a task sets its own lane. Lanes are operator-defined "
                    "policies; raw provider/model/API endpoint overrides are not "
                    "accepted here."
                ),
            },
            "tasks": {

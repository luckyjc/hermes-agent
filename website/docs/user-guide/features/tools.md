...
Common toolsets include `web`, `search`, `terminal`, `file`, `browser`, `untrusted_link_sandbox`, `vision`, `image_gen`, `moa`, `skills`, `tts`, `todo`, `memory`, `session_search`, `cronjob`, `code_execution`, `delegation`, `clarify`, `homeassistant`, `messaging`, `debugging`, `safe`, and `rl`.

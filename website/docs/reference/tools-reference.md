...
**Quick categories:** browser automation including CDP/dialog support, file tools, RL tools, Home Assistant tools, terminal/process tools, web tools, document extraction, untrusted-link sandbox tools, Feishu tools, Spotify tools, Yuanbao tools, Discord tools, and standalone tools across other toolsets.
